...
function generateScheme({category, skillID}) {
    ...
    scheme.addChild(
        new ContainerScheme('계획', {
            ...
            sorts: PropertySort.Descending('Status').add(
                PropertySort.Descending('EndDate'),
            ),
        }),
    );

    scheme.addChild(
        new ContainerScheme('자격증', {
            ...
            filter: ANDFilter.of(
                ...
                MultiSelectFilter.Contains('Tags', category),
            ),
        }),
    );
            ...
            new ContainerScheme('프로젝트', {
                ...
                scheme: new DatabaseScheme('프로젝트', {
                    scheme: new PageScheme('프로젝트', {
                        ...
                        '요약(50자)': NestedProperty.RichText(
                            '요약(50자)',
                            '%7CN%3AE',
                        ),
                ...
                filter: ANDFilter.of(
                    CheckBoxFilter.Equals('_hidden', false),
                    RelationFilter.Contains('기술', skillID),
                ),
