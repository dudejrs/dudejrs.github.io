...
export default function({type='count', width, height, radius, types, fields, className, hidden=false}){
	...
	return (<SpiderChart 
					...
					height={height}
					>
					{ !hidden && allTypes.length && <DropdownTagList className={styles.tagList} names={allTypes} tags={types_} callback={setTypes}/> }
			</SpiderChart>
			)
}