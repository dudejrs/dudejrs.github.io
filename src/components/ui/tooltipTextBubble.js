    ...
    return (
        <div
            ...
            style={{
                top: `-0.8rem`,
                left: `0.75rem`,
                transform: `translate(-${width / 2}px, -${height * 0.7}px)`,
                width: `${width}px`,
            }}
        >
            <svg
        ...
        >
            ...
            >
                <g>
                    ...
                    />
                    <polygon
                        points={`0 ${totalHeight / 2} 0 ${totalHeight / 2} ${tailWidth + 1} ${totalHeight / 2 - tailHeight / 2} ${tailWidth + 1} ${totalHeight / 2 + tailHeight / 2} 0 ${totalHeight / 2}`}
                    />
                </g>
            </svg>
            <div
    ...
    return (
        ...
        >
            <svg
                ...
                className={`${styles.bubble}`}
                height={`${height}px`}
                style={{transform: `translate(-23.5%,0)`}}
            >
                <g>
                    <rect
                        x={totalWidth - boxWidth - tailWidth}
                        width={boxWidth}
                        height={boxHeight}
                        rx="30"
                    />
                    <polygon
                        points={`${totalWidth} ${totalHeight / 2} ${totalWidth} ${totalHeight / 2} ${totalWidth - tailWidth} ${totalHeight / 2 - tailHeight / 2} ${totalWidth - tailWidth} ${totalHeight / 2 + tailHeight / 2} ${totalWidth} ${totalHeight / 2}`}
                    />
                </g>
            </svg>
            <div
        ...
        >
            ...
            >
                <g>
                    ...
                    />
                    <polygon
                        points={`${totalWidth / 2} 0 ${totalWidth / 2} 0 ${totalWidth / 2 - tailWidth / 2} ${tailHeight} ${totalWidth / 2 + tailWidth / 2} ${tailHeight} ${totalWidth / 2} 0`}
                    />
                </g>
            </svg>
            <div
